            ...
            <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                    ...
                    <div class="pt-6 text-center">
                        <p class="text-lg leading-normal font-bold mb-1">{{ $member->name }}</p>
                        <p class="text-gray-500 leading-relaxed font-light">{{ $member->position }}</p>
                        <!-- social icon -->
                        @foreach ($member->teamSocials as $social)
                            <div class="mt-2 mb-5 space-x-2">
                                @if ($social->type == 'twitter')
                                    <a class="hover:text-blue-700" aria-label="Twitter link"
                                        href="{{ $member->twitter }}">
                                ...
                                @if ($social->name == 'facebook')
                                    <a class="hover:text-blue-700" aria-label="Facebook link"
                               ...
                               @if ($social->name == 'linkedin')
                                    <a class="hover:text-blue-700" aria-label="Linkedin link"
